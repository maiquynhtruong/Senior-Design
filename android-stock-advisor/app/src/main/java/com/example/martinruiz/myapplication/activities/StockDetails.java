...
public class StockDetails extends AppCompatActivity {
    @BindView(R.id.textViewCardCompanyName) TextView textViewCompanyName;
    @BindView(R.id.textViewCardStockDescription) TextView textViewStockDescription;
    ...
    @BindView(R.id.imageViewCardStockIcon) ImageView imageViewStockIcon;
